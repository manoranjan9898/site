...
$(document).ready(function () {
    $('#fullpage').fullpage({
        anchors: ['header', 'features', 'thirdPage']
    });
});
...
var init = function() {
	...
	texture = THREE.ImageUtils.loadTexture("https://image.ibb.co/dErVxy/transparent_Map.png", undefined, function() {
